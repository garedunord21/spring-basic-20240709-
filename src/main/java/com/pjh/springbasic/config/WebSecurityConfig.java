package com.pjh.springbasic.config;
...
import com.pjh.springbasic.filter.JwtAuthenticationFilter;
import com.pjh.springbasic.handler.OAuth2SuccessHandler;
import com.pjh.springbasic.service.implement.OAuth2UserServiceImplement;
...
public class WebSecurityConfig {
    ...
    protected SecurityFilterChain configure(HttpSecurity security) throws Exception {
        ...
        security
            ...
            // 요청 URL의 패턴에 따라 인증이 필요한 작업인지 인가가 필요한 작업인지를 지정하는 설정
